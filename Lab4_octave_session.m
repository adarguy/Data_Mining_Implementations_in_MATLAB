% Tutorial Code from Stanford Machine Learning Class 
% Octave tutorial 

% =======================================================
% Section 1: Octave Tutorial: Basic operations
% Add a semicolon ";" to suppress display after each sentence
...
%length() applied more on vectors. if on matrix, more confusible 


%% loading data
pwd    % show current directory (current path)
mkdir octave    % create a folder named "octave"
cd 'octave'   % change directory 
pwd
ls     % list files in current directory 

load data.csv   % copy and paster data.csv to folder "octave"
who    % list variables in workspace
whos   % list variables in workspace (detailed view) 

rows(data)     % number of rows
columns(data)     % number of columns
v = data(1:10, 1:3);
save hello v;   % save variable v into file hello.mat
save hello.txt v -ascii; % save as ascii
clear data       % clear w/ no argt clears all
...
A .* B % element-wise multiplcation  - element operations
...
addpath('/home/<youraccount>/octave');
cd '/home'
squareThisNumber(5);
